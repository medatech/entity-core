...
/**
 * This function helps us remove an existing child out of the chain by making it's immediately before/after neighbours become
 * direct neighbors of themselves.
 */
